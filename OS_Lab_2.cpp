...
void PrintMenu() {
    std::cout << "+---+---------------------------------------------------------------------------------------------+\n"
              ...
              << "+---+---------------------------------------------------------------------------------------------+\n"
              << "| 4 | резервирование региона в автоматическом режиме                                              |\n"
              << "+---+---------------------------------------------------------------------------------------------+\n"
              << "| 5 | резервирование в режиме ввода адреса начала региона                                         |\n"
              << "+---+---------------------------------------------------------------------------------------------+\n"
              << "| 6 | резервирование региона и передача ему физической памяти в автоматическом режиме             |\n"
              << "+---+---------------------------------------------------------------------------------------------+\n"
              << "| 7 | резервирование региона и передача ему физической памяти в режиме ввода адреса начала региона|\n"
              << "+---+---------------------------------------------------------------------------------------------+\n"
              << "| 8 | установка защиты доступа для заданного (с клавиатуры) региона памяти и ее проверку          |\n"
              << "+---+---------------------------------------------------------------------------------------------+\n"
              << "| 9 | возврат физической памяти и освобождение региона адресного пространства заданного           |\n"
              << "+---+---------------------------------------------------------------------------------------------+\n"
              << "|10 | запись данных в ячейки памяти по заданным с клавиатуры адресам                              |\n"
              << "+---+---------------------------------------------------------------------------------------------+\n"
              << "|11 | вывод данных в ячейках памяти по заданным с клавиатуры адресам                              |\n"
              << "+---+---------------------------------------------------------------------------------------------+\n"
